...
public record RequestCriarPedidoDto(@Schema(description = "Insira aqui o número da mesa a qual o pedido pertence", example = "1")
                                    Integer mesa,
                                    ...
                                    String observacao,
                                    @Schema(description = "Insira aqui o codigo do item do pedido e sua quantidade desejada")
